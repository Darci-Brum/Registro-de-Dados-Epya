...
function renderDashboard() {
  ...
  return `<section class="view dashboard-view"><article class="dashboard-hero"><div class="hero-copy"><div class="hero-kicker"><span>Controle de recebimentos</span></div><h1>Controle diário de<br />dormentes e trilhos.</h1><p>Notas fiscais, quantidades, qualidade e avanço físico reunidos em uma visão clara da obra.</p><div class="hero-actions no-print">${renderSyncBadge()}${canEdit() ? '<button class="button button-yellow" data-new-record>+ Novo recebimento</button>' : ""}<button class="button button-glass" data-nav="reports">Gerar relatório</button></div></div><div class="hero-corner-brand"><img src="./arauco-sucuriu-logo.svg" alt="Símbolo do Projeto Sucuriú" /><span><strong>ARAUCO</strong><small>Projeto Sucuriú</small></span></div><aside class="hero-quote hero-quote-quality" aria-label="Qualidade é compromisso"><span>Qualidade é</span><strong>compromisso.</strong></aside><aside class="hero-quote hero-quote-control" aria-label="Onde há controle, há qualidade"><span>Onde há controle,</span><strong>há qualidade.</strong></aside></article>
